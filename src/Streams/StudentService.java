...
public class StudentService {
    private List<StudentManagmentSystem.Student> students;

    public StudentService() {
        loadFromFile();
    }

    public List<StudentManagmentSystem.Student> getStudents() {
        return students;
    }

    public void addStudent(StudentManagmentSystem.Student student){
    ...
    public void showAllStudents(){
        for (int i = 0; i < students.size(); i++) {
            StudentManagmentSystem.Student student = students.get(i);
            System.out.printf("%s %s %d\n", student.getFirstName(), student.getLastName(), student.getFacNum());
        }
    }

    public void showStudentDetails(int facNum){
        StudentManagmentSystem.Student student = students.stream().filter(s -> s.getFacNum() == facNum).toList().get(0);
    ...
    public void showTopStudent(){
        ...
        StudentManagmentSystem.Student student = students.get(ind);
        System.out.printf("%s %s %d with average grade\n", student.getFirstName(), student.getLastName(), student.getFacNum(), averageGrade(student));
    }
    ...
    public void saveToFile(){
        try {
            ...
            for(StudentManagmentSystem.Student student: students){
    ...
    private double averageGrade(StudentManagmentSystem.Student student){
        double sum = 0;
    ...
    private void loadFromFile(){
        try {
            ...
            while((line = bufferedReader.readLine()) != null){
                ...
                StudentManagmentSystem.Student student = new Student(data[1], data[2], Integer.parseInt(data[3]));
